...
if(isset($_GET['id'])){
	...
	if ($filter == 2){
		...
		$sql = "SELECT productid, productname, catid, manufacturer, stockno, partno, sku, pickcode, description, qty, price, datecode, vendordetails, img, flag FROM products WHERE LOWER(productname)='$search'";*/
	}else{
		//$filter == 1
