...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td height="25" bgcolor="#230113"><div align="center" class="style6">
      <form name="start_form" action="product_list.php" method="post">
        ...
        <?php 
					foreach(range('A','Z') as $i){
						?>
        <a href="javascript:void(0)" onclick="document.forms['start_form'].start.value='<?=$i?>'; document.forms['start_form'].submit();" class="start">
          <?=$i?>
          </a>
        <?
					}
    ...
    </div></td><td><div align="right"><p><a href="export.php?query="+<?PHP echo $sql;?>/>EXPORT</a></p></div></td>
  </tr>
  <tr>
    <td height="25"></td>
  </tr>
  <tr>
    <td height="25"><div style="overflow:auto; background-color:#FFFFFF; width:850px; height:340px;" id="productslist">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="100" height="20" bgcolor="#000000" style="color:#FFFFFF; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px;"><div align="center"><strong> Stock #</strong></div></td>
          <td width="250" height="20" bgcolor="#000000" style="color:#FFFFFF; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px;"><div align="center"><strong>Product desc</strong></div></td>
          <td width="150" height="20" bgcolor="#000000" style="color:#FFFFFF; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px;"><div align="center"><strong>Manufacturer</strong></div></td>
          <td width="150" height="20" bgcolor="#000000" style="color:#FFFFFF; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px;"><div align="center"><strong>Part #</strong></div></td>
          <td width="80" height="20" bgcolor="#000000" style="color:#FFFFFF; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px;"><div align="center"><strong>Datecode</strong></div></td>
          <td width="50" height="20" bgcolor="#000000" style="color:#FFFFFF; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px;"><div align="center"><strong>Qty</strong></div></td>
          <td width="70" bgcolor="#000000" style="color:#FFFFFF; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px;"><div align="center"><strong>Price</strong></div></td>
        </tr>
        <?
		$counter = 0;
        ...
        <tr>
          <form name="show_form<?=$productid?>" action="showproduct.php" method="post">
            ...
            <td height="80" bgcolor="<?= $color; ?>" style="color:#000000; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; cursor:pointer;" onclick="document.forms['show_form<?=$productid?>'].submit();"><div align="center">
              <?= $stockno; ?>
            </div></td>
            <td height="80" bgcolor="<?= $color; ?>" style="color:#000000; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; cursor:pointer;" onclick="document.forms['show_form<?=$productid?>'].submit();"><div align="center">
              <?= $productname; ?>
          ...
          <td height="80" bgcolor="<?= $color; ?>" style="color:#000000; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px;"><div align="center">
